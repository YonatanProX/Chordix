...
const HTML = {
  ...
  "metro.h": "Metronome",
  "tun.mode.ukulele": "Ukulele",
  "tun.mode.guitar": "Guitar",
  "tun.modesLabel": "Choose instrument",
  ...
  "capo.outH": "Result",
  "tips.eyebrow": "Guide",
  "tips.title": "Tips for a sharper sheet",
  "tips.lead": "The analysis runs on its own and gets it right most of the time — but there are a few spots where you can lend a hand. Here are the things that change the result most, and where to fix it yourself when something comes out off.",
  "tips.1.h": "Give it the whole song",
  "tips.1.p": "The engine learns a song from its repetitions, so a short clip makes it harder. Upload the full recording — ideally a studio version. A live take with a crowd and noise is almost always harder to read.",
  "tips.2.h": "Bars came out doubled or halved",
  "tips.2.p": "On very slow or very fast songs the engine sometimes counts the tempo at double, or half. One press of ÷2 or ×2 lines the bars and structure back up.",
  "tips.3.h": "A chord with a dashed underline",
  "tips.3.p": "The dashed line is how Chordix says “I'm less sure here.” It's worth a quick listen — and if you need to, clicking the chord opens a fast edit.",
  "tips.4.h": "A verse labelled chorus, or the reverse",
  "tips.4.p": "Change the section's name from the menu beside it, and every matching section updates with it. One fix sorts the whole page.",
  "tips.5.h": "Move it to a key that suits you",
  "tips.5.p": "The minus and plus buttons shift the whole sheet up or down. And when every chord lands exactly a semitone high or low, the recording isn't tuned to A=440 — “Re-tune” sorts it out.",
  "tips.6.h": "Save it, print it, share it with the band",
  "tips.6.p": "“Save to library” keeps the sheet with all your corrections, and “Save as PDF” gives you a clean file to print or send to the rest of the players.",
  ...
  "tips.1.w": "Before you upload",
  "tips.2.w": "The “Chords not accurate?” panel",
  "tips.3.w": "On the chord sheet",
  "tips.4.w": "In a section heading",
  "tips.5.w": "In the bar above the sheet",
  "tips.6.w": "When the sheet is ready",
  ...
  "pg.tun.title": "Guitar & ukulele tuner",
  "pg.tun.lead": "Pick guitar or ukulele and tune through your phone or computer mic — or by ear with a reference tone. Everything runs on your device.",
...
const ATTR = {
  ...
  "tun.stringsLabel": "The strings — tap to hear a reference tone",
